...
namespace Unity.Entities
{
    ...
    public unsafe partial class PreUpdateBarrierSystem : EntityCommandBufferSystem
    {
        NativeList<JobHandle> m_JobHandles;

        List<Action> m_SyncCallbacks;
        ...
        protected override void OnUpdate()
        {
            ...
            foreach (var action in m_SyncCallbacks)
            {
                action.Invoke();
            }
        ...
        public void AddBarrierJob(JobHandle job)
        {
            m_JobHandles.Add(job);
        }

        public void AddSyncCallback(Action action)
        {
        ...
        {
            base.OnCreate();
            m_JobHandles = new NativeList<JobHandle>(8, Allocator.Persistent);
            m_SyncCallbacks = new List<Action>();
        }
