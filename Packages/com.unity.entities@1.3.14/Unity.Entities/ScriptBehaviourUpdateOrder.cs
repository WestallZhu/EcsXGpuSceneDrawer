...
namespace Unity.Entities
{
    ...
    public static class ScriptBehaviourUpdateOrder
    {
        ...
        public static void AppendWorldToPlayerLoop(World world, ref PlayerLoopSystem playerLoop)
        {
            ...
            var preUpdateBarrierSystem = world.GetExistingSystemManaged<PreUpdateBarrierSystem>();
            if (preUpdateBarrierSystem != null)
                AppendSystemToPlayerLoop(preUpdateBarrierSystem, ref playerLoop, typeof(PreUpdate));
